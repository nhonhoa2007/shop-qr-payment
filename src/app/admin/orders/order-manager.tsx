            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
                <div className="text-sm space-y-1">
                  ...
                  {order.note && <p className="text-xs text-amber-700 bg-amber-50 p-2 rounded-lg mt-2">📝 Ghi chú: {order.note}</p>}
                </div>
                ...
                <div className="flex items-center gap-2">
                  {order.paymentStatus !== 'PAID' ? (
                    <button
                      ...
                      className="px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white rounded-lg text-xs font-semibold transition flex items-center gap-1 shadow-sm"
                    >
                      <span>💰</span>
